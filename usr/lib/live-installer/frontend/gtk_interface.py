...
class InstallerWindow:
    ...
    def __init__(self, fullscreen=False):
        ...
        os.system("sudo -u gooroom gsettings set org.cinnamon.desktop.screensaver lock-enabled false 2> /dev/null")
        os.system("sudo -u gooroom gsettings set org.mate.screensaver lock-enabled false 2> /dev/null")
    ...
    def do_install(self):        
        ...
        slideThr = Slideshow(self.slideshow_browser, self.slideshow_path, language=self.cur_country_code)
